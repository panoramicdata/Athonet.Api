...
# Write-Host is unavailable to hosts without a console and cannot be redirected, so status output
# goes through Write-Information instead. Colour is applied with $PSStyle where the host supports
# it, and simply omitted where it does not.
function Write-Status {
	...
	if ($Colour -and $PSStyle -and $PSStyle.OutputRendering -ne 'PlainText') {
